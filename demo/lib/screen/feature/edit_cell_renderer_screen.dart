...
class _EditCellRendererScreenState extends State<EditCellRendererScreen> {
  ...
  void initState() {
                ...
                IconButton(
                  ...
                  onPressed: () async {
                    ...
                    final DateTime? picked = await showDatePicker(
                      context: context,
                      initialDate: DateTime.tryParse(cell.value.toString()) ??
                          DateTime.now(),
    ...
    rows.addAll(List.generate(10, (index) {
      return TrinaRow(cells: {
        ...
        'column5': TrinaCell(value: DateTime.now().add(Duration(days: index))),
        'column6':
            TrinaCell(value: DateTime.now().add(Duration(days: index * 2))),
