...
void main() {
  ...
  tenByTenGrid
      .test('Tap the filter of the 2nd column and move left with the arrow key',
          (tester) async {
  ...
  tenByTenGrid
      .test('Tap the filter of the 0th column and move with the Tab key',
          (tester) async {
    final firstColumnFilter = findFilter('column0');
  ...
  tenByTenGrid
      .test('Tap the filter of the 2nd column and move with Shift+Tab key',
          (tester) async {
    final firstColumnFilter = findFilter('column2');
