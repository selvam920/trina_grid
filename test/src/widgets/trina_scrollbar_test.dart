...
void main() {
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: ScrollConfiguration(
          ...
          child: TrinaScrollbar(
            verticalController: verticalScroll,
            horizontalController: horizontalScroll,
            thickness: TrinaScrollbar.defaultScrollbarHoverWidth,
            thicknessWhileDragging: TrinaScrollbar.defaultScrollbarHoverWidth,
            mainAxisMargin: 0,
            crossAxisMargin: 0,
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      const scrollbarPosition = Offset(
        screenWidth - (TrinaScrollbar.defaultScrollbarHoverWidth / 2),
        50,
      );
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      const scrollbarPosition = Offset(
        50,
        screenHeight - (TrinaScrollbar.defaultScrollbarHoverWidth / 2),
      );
      const moveOffset = 100.0;
