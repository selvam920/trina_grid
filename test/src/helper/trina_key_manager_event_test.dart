...
void main() {
  ...
  late TrinaKeyManagerEvent? keyManagerEvent;

  KeyEventResult callback(FocusNode node, KeyEvent event) {
    keyManagerEvent = TrinaKeyManagerEvent(
      focusNode: node,
      event: event,
  ...
  testWidgets('When any key is pressed, isKeyDownEvent must be `true`.', (
    tester,
  ) async {
  ...
  testWidgets('When the Home key is pressed, isHome must be `true`.', (
    tester,
  ) async {
    late TrinaKeyManagerEvent keyManagerEvent;

    KeyEventResult callback(FocusNode node, KeyEvent event) {
      keyManagerEvent = TrinaKeyManagerEvent(focusNode: node, event: event);
  ...
  testWidgets('When the Shift key is pressed, isShift must be `true`.', (
    tester,
  ) async {
    await buildWidget(tester: tester, callback: callback);
  ...
  testWidgets('When the Control key is pressed, isControl must be `true`.', (
    tester,
  ) async {
    await buildWidget(tester: tester, callback: callback);
  ...
  testWidgets('When Control + C keys are pressed, isCtrlC must be `true`.', (
    tester,
  ) async {
    await buildWidget(tester: tester, callback: callback);
  ...
  testWidgets('When Control + V keys are pressed, isCtrlV must be `true`.', (
    tester,
  ) async {
    await buildWidget(tester: tester, callback: callback);
  ...
  testWidgets('When Control + A keys are pressed, isCtrlA must be `true`.', (
    tester,
  ) async {
    await buildWidget(tester: tester, callback: callback);
