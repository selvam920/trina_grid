  ...
  group('insertRows', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        List<TrinaRow> rows = [
          TrinaRow(sortIdx: 0, cells: {
            'text0': TrinaCell(value: '3'),
          }),
          TrinaRow(sortIdx: 1, cells: {
            'text0': TrinaCell(value: '1'),
          }),
          TrinaRow(sortIdx: 2, cells: {
            'text0': TrinaCell(value: '2'),
          }),
        ];
        ...
        final rowsToAdd = [
          TrinaRow(cells: {
            'text0': TrinaCell(value: 'a'),
          }),
          TrinaRow(cells: {
            'text0': TrinaCell(value: 'b'),
          }),
          TrinaRow(cells: {
            'text0': TrinaCell(value: 'c'),
          }),
        ];
      ...
      (WidgetTester tester) async {
        ...
        List<TrinaColumn> columns = [
          ...
          TrinaColumn(
            title: 'select',
            field: 'select',
            type: TrinaColumnType.select(<String>['One', 'Two'],
                defaultValue: 'Two'),
          ),
          TrinaColumn(
            title: 'date',
