...
void main() {
        ...
        for (var rowIdx in [0, 1, 5, 6, 7, 8, 9]) {
          for (var column in ['left', 'body', 'right']) {
            for (var idx in [0, 1, 2]) {
              expect(
                rows[rowIdx].cells['$column$idx']!.value,
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        stateManager.setCurrentSelectingPosition(
          cellPosition: const TrinaGridCellPosition(columnIdx: 6, rowIdx: 4),
        );
  ...
  group('changeCellValue', () {
    ...
    test('force is false (default) and canNotChangeCellValue is true, '
    ...
    test('force is true and canNotChangeCellValue is true, '
