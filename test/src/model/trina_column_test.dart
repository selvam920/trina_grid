...
void main() {
  ...
  group('TrinaColumnTypeText 의 defaultValue', () {
    test(
      ...
      () {
        final TrinaColumnTypeText column = TrinaColumnType.text(
          defaultValue: 'default',
        ) as TrinaColumnTypeText;
    ...
    test(
      ...
      'then defaultValue should be set.',
      () {
        final TrinaColumnTypeNumber column = TrinaColumnType.number(
          defaultValue: 123,
        ) as TrinaColumnTypeNumber;
    ...
    test(
      ...
      'then defaultValue should be set.',
      () {
        final TrinaColumnTypeSelect column = TrinaColumnType.select(
          <String>['One'],
          defaultValue: 'One',
    ...
    test(
      ...
      'then defaultValue should be set.',
      () {
        final TrinaColumnTypeDate column = TrinaColumnType.date(
    ...
    test(
      ...
      'then defaultValue should be set.',
      () {
        final TrinaColumnTypeTime column = TrinaColumnType.time(
          defaultValue: '20:30',
        ) as TrinaColumnTypeTime;
  ...
  group('TrinaColumnTypeNumber', () {
    ...
    group('isValid', () {
      ...
      test(
        ...
        'then isValid should be false.',
        () {
          final TrinaColumnTypeNumber numberColumn = TrinaColumnType.number(
            negative: false,
          ) as TrinaColumnTypeNumber;
    ...
    group(
      ...
      () {
        ...
        test(
          ...
          () {
            final TrinaColumnTypeDate column =
                TrinaColumnType.date(format: 'MM/dd/yyyy')
                    as TrinaColumnTypeDate;
