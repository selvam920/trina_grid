...
mixin LayoutState implements ITrinaGridState {
  ...
  @override
  double get footerTopOffset =>
      maxHeight! - footerHeight - TrinaGridSettings.totalShadowLineWidth;
  ...
  @override
  double get columnBottomOffset =>
      maxHeight! - rowsTopOffset - TrinaGridSettings.totalShadowLineWidth;
  ...
  @override
  double get bodyUpScrollOffset {
    return bodyTopOffset + TrinaGridSettings.offsetScrollingFromEdge;
  }
  ...
  bool enoughFrozenColumnsWidth(double width) {
    return width >
        (leftFrozenColumnsWidth +
            rightFrozenColumnsWidth +
            TrinaGridSettings.bodyMinWidth +
            TrinaGridSettings.totalShadowLineWidth);
  }
