...
class TrinaScrollbar extends StatefulWidget {
  const TrinaScrollbar({
    super.key,
  ...
  @override
  TrinaGridCupertinoScrollbarState createState() =>
      TrinaGridCupertinoScrollbarState();
}

class TrinaGridCupertinoScrollbarState extends State<TrinaScrollbar>
  ...
  @override
  void didUpdateWidget(TrinaScrollbar oldWidget) {
